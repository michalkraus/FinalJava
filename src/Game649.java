...
public class Game649 {
    ...
    public static void main (String [] args) {
        ...
        table.add(0,game649.rgTable.drawnNumbersTable);
        ...
        game649.rgTable.setDrawnNumbersTable(assignTable);


        //Lottery number 2
        System.out.println("\nThis is Lottery Number 2: ");
        game649.numberGenerator();
        table.add(1,game649.rgTable.drawnNumbersTable);
        ...
        game649.numberGenerator();
        table.add(2,game649.rgTable.drawnNumbersTable);
        ...
        System.out.println("\nIf you ask, you can get a single number from the scores, example: this index 3(position4)" +
                "of Lottery 3...: " + game649.rgTable.getSingleNumberFromDrawnNumbersTable(3));
